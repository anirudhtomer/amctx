...
\begin{document}
\title{\LARGE \textbf{Supplementary Material for ``Personalized screening intervals to monitor the development of chronic renal allograft failure: an observational cohort and simulation study''}}

\author[1,2,*]{\large Hessel Peters-Sengers}
\author[3,*]{Anirudh Tomer}
\author[4]{Sandrine Florquin}
\author[4]{Joris JTH Roelofs}
\author[5,6]{Ewout W Steyerberg}
\author[1]{Frederike J Bemelman}
\author[3,\$]{Dimitris Rizopoulos}
\author[4,7,$\star$, \$]{Jesper Kers}
...
\affil[$\star$]{Correspondence to Jesper Kers: j.kers@amc.uva.nl}
\date{}
...
\clearpage
\input{mainmatter/jm_amctx}
\clearpage
\input{mainmatter/sim_study}
\clearpage
\input{mainmatter/source_code}
