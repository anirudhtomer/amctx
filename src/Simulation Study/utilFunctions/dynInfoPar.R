dynInfoPar <- function (object, newdata, Dt, K = 5, M = 500, idVar = "id", maxRiskTime = 0.5,
  ...
  u_times <- lapply(lapply(times, seq, to = 10, length.out = 31), tail, n = -1)
...
environment(dynInfoPar) <- asNamespace('JMbayes')